...
subplot(4,6,ep*6-4+d)     
    for v=1:3
        u=u+1;
        clear I
           I= InfoTrial.Repeat>-1 & InfoTrial.SaccadeStart>500 & GC_I==1 & InfoTrial.ChoiceD==d & InfoTrial.ChosenPercScale==v;
...
print( FigHandle, '-djpeg', [DirFig,'Ch',num2str(ch),'Unit',num2str(unit),'_GS_Prob']);
