function SpikeOrgRigBRFV4(filename,Eventfile,Ch_num,DirFig,recordname,RFFigs)
close all
...
for ch=1:Ch_num
    ...
    [Inf_RS,Sig0]=MutualInfo_NM(tsNum_Ch,RF_location,4,25);
...
print( h10, '-djpeg', [RFFigs,'V4',char(recordname),'1']);
print( h10, '-depsc', [RFFigs,'V4',char(recordname),'1']);
h10=figure(2);
print( h10, '-djpeg', [DirFig,'RFContour']);
print( h10, '-depsc', [DirFig,'RFContour']);
print( h10, '-djpeg', [RFFigs,'V4',char(recordname),'2']);
print( h10, '-depsc', [RFFigs,'V4',char(recordname),'2']);
h10=figure(3);
print( h10, '-djpeg', [DirFig,'RF2D']);
print( h10, '-depsc', [DirFig,'RF2D']);
print( h10, '-djpeg', [RFFigs,'V4',char(recordname),'3']);
print( h10, '-depsc', [RFFigs,'V4',char(recordname),'3']);
%%
