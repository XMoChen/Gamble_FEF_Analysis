...
function FCTrainingDriftFixblackStepJuice
...
%     OnsetLength=10; % per condition
 ...
 %%%%%%%    change for behavior
    ...
    Type_ID=[ones(1,PopLength),2*ones(1,OnsetLength*6),3*ones(1,FreeLength)];
