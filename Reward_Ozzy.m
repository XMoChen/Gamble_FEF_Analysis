 function Reward_Ozzy(Spikefile,Eventfile,DirFig,Ch_num,name0)
%%%% dock the figures
...
%                 Spike_min=0.5;
                ...
                for d=1:2%4
                    ...
                    for v=[2,16,17,18]
                        ...
                        clear I
                        I= InfoTrial.Repeat==2 & GS_I==1 & InfoTrial.ChoiceD==d & InfoTrial.ChoiceOpt==v;
                        ...
                        clear I
                        I= InfoTrial.Reward==0  & InfoTrial.Repeat==0 & GS_I==1 & InfoTrial.ChoiceD==d & InfoTrial.ChoiceOpt==v;
                        plotstd(t,Spike(I,:),[char(V_Color(u)),':']);hold on;
                ...
                for d=1:2%4
                    ...
                    for v=[2,16,17,18]
                        ...
                        clear I
                        I= InfoTrial.Reward==0  & InfoTrial.Repeat==0 & GC_I==1 & InfoTrial.ChoiceD==d & InfoTrial.ChoiceOpt==v;
                        plotstd(t,Spike(I,:),[char(V_Color(u)),':']);hold on;
                        axis(clim);
