...
function RigBForceMIBStillGreyOverlap
...
try
    ...
    tgr=round(ppd*3); %radius of fixation point
...
%%%%%%%%%%%%%%%%%%%%%%%% for onset different task %%%%%%%%%% %%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Orientation_squence0=Orientation_squence(I0);
      ...
      I_overlap0=mod(I_overlap,6)*0.05;
...
%         Screen('DrawTexture', w, textureIdx,[],t1Rect,45);
%         Screen('FillOval',w,fp_color, [center(1)-fpr+x_fp, center(2)-fpr-y_fp, center(1)+fpr+x_fp, center(2)+fpr-y_fp],pi/4); 
...
%     Screen('DrawingFinished', w); 
    ...
    Screen('FillRect',w, BackGray);
    Screen('FillOval',w,[0 0 0], [center(1)-fpr+x_fp, center(2)-fpr-y_fp, center(1)+fpr+x_fp, center(2)+fpr-y_fp]); 
    Screen('DrawingFinished', w); 
	t_start_trial=Screen('Flip', w);
