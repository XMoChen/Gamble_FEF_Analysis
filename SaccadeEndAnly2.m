function [FireAll,FireAll_C]=SaccadeEndAnly2 (Eventfile,Spikefile,record)
load(Eventfile);
load(Spikefile);
...
%             end
            ...
            FireAll_C(contr,d,u,nu,1:20,:)=nan(30,size(TargetRate1,3));           
...
%%
lim=[-300 800 min(FireMean(:))*0.9 max(FireMean(:))*1.2];
