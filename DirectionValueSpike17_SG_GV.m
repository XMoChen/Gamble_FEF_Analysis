...
if ep==1
      t=-300:501;
      clim=[-200 500 Spike_min*0.8 Spike_max*1.4]; 
elseif ep==2
      t=-500:1001;
      clim=[-200 800 Spike_min*0.4 Spike_max*1.4]; 
elseif ep==3
     t=-500:501;
     clim=[-500 400 Spike_min*0.4 Spike_max*1.4]; 
else
      t=-500:501;
...
for d=1:2%4      
        u=0;
    I= InfoTrial.Repeat>-1 & InfoTrial.SaccadeStart>500 & GS_I==1 & InfoTrial.ChoiceD==d & InfoTrial.ChoiceOpt<10;
...
for d=1:2%4      
        u=0;
    I= InfoTrial.Repeat>-1 & InfoTrial.SaccadeStart>500 & GC_I==1 & InfoTrial.ChoiceD==d & InfoTrial.ChoiceOpt<10;
    plotstd(t,Spike(I,:),char(Direction_Color(d)));hold on;    
  axis(clim);     
end
