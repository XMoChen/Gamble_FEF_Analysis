...
%           SelectSig(ch,unit,:)=hSig(unit_all,:);
          ...
          if 1==1%hSig(unit_all,1)==0 & hSig(unit_all,3)==0 & hSig(unit_all,4)==0 & hSig(unit_all,5)==0% ...
            ...
            figure(unit_all) 
            Epoch={'BG','TG','SC','RT'};
                Spike_max=max(nanmean(Spike_RT,2))*1.5;
                Spike_min=min(nanmean(Spike_RT,2))*0.5;
            ...
            %%%% Align on target onset
                ...
                for d=1:2%4
                    ...
                    for v=[2,16,17,18]
                        ...
                        subplot(4,6,u+(d-1)*6)
                        clear I
                        I= InfoTrial.Reward==4 & InfoTrial.Repeat==0 & InfoTrial.SaccadeStart>500 & GS_I==1 & InfoTrial.ChoiceD==d & InfoTrial.ChoiceOpt==v;
                        plotstd(t,Spike(I,:),char(V_Color(u)));hold on;

                        I= InfoTrial.Reward==2 & InfoTrial.Repeat==0 & InfoTrial.SaccadeStart>500 & GS_I==1 & InfoTrial.ChoiceD==d & InfoTrial.ChoiceOpt==v;
                        plotstd(t,Spike(I,:),'k');hold on;

                        
                        I= InfoTrial.Reward==10^-3 & InfoTrial.Repeat==0 & InfoTrial.SaccadeStart>500 & GS_I==1 & InfoTrial.ChoiceD==d & InfoTrial.ChoiceOpt==v;
                        plotstd(t,Spike(I,:),[char(V_Color(u)),':']);hold on;
                                        axis(clim);
                ...
                xlabel(['From Result onset']); %title('Choice');
                    ...
                    for v=[2,16,17,18]
                        ...
                        I= InfoTrial.Reward== 4 & InfoTrial.Repeat==0 & InfoTrial.SaccadeStart>500 & GC_I==1 & InfoTrial.ChoiceD==d & InfoTrial.ChoiceOpt==v;
                        plotstd(t,Spike(I,:),char(V_Color(u)));hold on;
                       
                        I= InfoTrial.Reward==2 & InfoTrial.Repeat==0 & InfoTrial.SaccadeStart>500 & GS_I==1 & InfoTrial.ChoiceD==d & InfoTrial.ChoiceOpt==v;
                        plotstd(t,Spike(I,:),'k');hold on;
                        
                        I= InfoTrial.Reward==10^-3  & InfoTrial.Repeat==0 & InfoTrial.SaccadeStart>500 & GC_I==1 & InfoTrial.ChoiceD==d & InfoTrial.ChoiceOpt==v;
                        plotstd(t,Spike(I,:),[char(V_Color(u)),':']);hold on;
                                        axis(clim);
...
%             print( FigHandle, '-djpeg', [DirFig,'Ch',num2str(ch),'Unit',num2str(unit),'_RT']);
% 
%           
