function SpikeOrgRigBRF_OnOff(filename,Eventfile,Ch_num,DirFig,recordname,RFFigs,SaveSpikefile)
close all
...
print( h10, '-djpeg', [RFFigs,'V4',char(recordname)]);
print( h10, '-depsc', [RFFigs,'V4',char(recordname)]);
save(SaveSpikefile,'RF_all_Info','-append');
% h10=figure(2);
