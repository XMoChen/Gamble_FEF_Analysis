function SpikeOrgTsRF(filename,Eventfile,Ch_num,EventOutfile,SpikeOutfile,BasicInfo)
close all
% filename=plx_filenameRF;
load('D:\Projects\GambleMIB\Gamble\ProbList.mat');
load(Eventfile,'table','Stim_list');
% SpikeOutfile=SaveSpikefile;
% EventOutfile=SaveEventfile;
...
clear ProbLocations
    [ProbLocations.xaxis,ProbLocations.yaxis]=(meshgrid(-30:10:10,-20:10:20));
