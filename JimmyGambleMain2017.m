...
l=1;
for record=1:length(Files)%:13%9%1:7%6:7%:5%2%:4%[3,5:8]  % valid from 6
...
%         AlignEvenSpike(Spikefile,Eventfile,record,Ch_num,'Saccade',[500,500]);
     %  AlignEvenSpike(Spikefile,Eventfile,record,Ch_num,'Result',[500,800]);
           Spike_Gamble_Jimmy_ISI(Eventfile,Spikefile,ChNum(record))
...
%              AlignEventLFP(LFPfile,Eventfile,Ch_num,'Saccade',[1000,800]);
        ...
        %     [Tg_FireAll,Tg_FireAll_C]=EventAnlyLFP (Eventfile,LFPfile,record,Ch_num,'Target',[500,500]);      %  %
        %     [Sac_FireAll,Sac_FireAll_C]=EventAnlyLFP (Eventfile,LFPfile,record,Ch_num,'Saccade',[500,500]);      %  %
        %     [Rst_FireAll,Rst_FireAll_C]=EventAnlyLFP (Eventfile,LFPfile,record,Ch_num,'Result',[500,500]);      %  %
        
%         DirMat='F:\Projects\GambleMIB\FEFLFPDataOrg\';
%         LFPOrgFile=[DirMat,char(Files(record)),'LFP.mat'];
%         LFPOrgFigure='F:\Projects\GambleMIB\FEFLFPDataOrg\figure\';
