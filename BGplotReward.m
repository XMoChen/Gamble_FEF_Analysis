    ...
    for unit=2%:length(l_ts(ch,:))
        if l_ts(ch,unit)>10000
            ...
            for contrast=3:-1:1
               ...
               for r=1:6
               r0=nanmean(Spike_BG((InfoTrial_valid.ContrastBG==contrast & InfoTrial_valid.LastLReward==Rewd(r) &  InfoTrial_valid.Targ2Opt==0 )',:),1);
...
%                for r=1:6
%                 r0=nanmean(Spike_BG((InfoTrial_valid.ContrastBG==contrast & InfoTrial_valid.LastLReward==Rewd(r) &  InfoTrial_valid.Targ2Opt==0 &  InfoTrial_valid.ChoiceD==2),:));
%                 [mr0,nr0]=plotminmax(t_bg,r0,mr0,nr0,r_color(r,:));
%                 end
%             title('FC NP')
%             
                ...
                for r=1:6
                r0=nanmean(Spike_BG((InfoTrial_valid.ContrastBG==contrast  & InfoTrial_valid.LastLReward==Rewd(r) &  InfoTrial_valid.Targ2Opt~=0 &  InfoTrial_valid.ChoiceD==1)',:),1);
                [mr0,nr0]=plotminmax(t_bg,r0,mr0,nr0,r_color(r,:));
                end
            title('2AC chose P')
                ...
                for r=1:6
                r0=nanmean(Spike_BG((InfoTrial_valid.ContrastBG==contrast  & InfoTrial_valid.LastLReward==Rewd(r) &  InfoTrial_valid.Targ2Opt~=0 &  InfoTrial_valid.ChoiceD==2)',:),1);
                [mr0,nr0]=plotminmax(t_bg,r0,mr0,nr0,r_color(r,:));
                end
            box off;set(gca,'TickDir','out')
            title('2AC chose NP')
